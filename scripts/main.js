...
if (storage.getSavedListNames()) {
    ...
    pageList = storage.rebuildListFromJSON(listJSON,"listTitle", "taskList", "descriptionParagraph");
} else {
    pageList = new todo.TodoList("mylist", "This is a description of a to-do list.", "listTitle", "taskList", "descriptionParagraph");
}
...
descriptionParagraph.addEventListener('click', pageList.editDescription.bind(pageList));
